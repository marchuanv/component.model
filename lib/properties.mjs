...
export class Properties {
    ...
    */
    onSet(propertyName, isReadOnly, isSerialised, callback) {
   ...
   /**
     ...
     * @param { Function } callback
    */
    onceSet(propertyName, isReadOnly, isSerialised, callback) {
        const { bag } = getPropertiesMap(this);
     ...
     * @param { Boolean } isSerialised
    */
    set(propertyName, propertyValue, isReadOnly, isSerialised) {
        const { bag } = getPropertiesMap(this);
